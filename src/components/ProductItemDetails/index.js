...
class ProductItemDetails extends Component {
  ...
  getProductDetails = async () => {
    ...
    if (response.ok) {
      ...
      const similarProductsFormattedData = data.similar_products.map(each =>
        this.getFormattedData(each),
      )
      this.setState({
        productDetails: formattedData,
        similarProductsData: similarProductsFormattedData,
  ...
  render() {
    return (
      <>
        <Header />
        <div className="specific-products-container">
